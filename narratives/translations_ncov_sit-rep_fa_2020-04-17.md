...
با در نظر‌گرفتن نمونه‌های توالی ژنتیکی از ایالت‌های میانه غربی می توان گستردگی همگن این نمونه‌ها به جای گروه شدن آن‌ها را در درخت مشاهده کرد. این بیانگر این است که تعداد کثیری معرف مستقل ویروس همراه با حلقه های مختلف انتقال در این ایالت ها وجود داشته‌است. 
